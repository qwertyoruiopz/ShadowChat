...
//		NSString *topic = [testArg substringWithRange:NSMakeRange(endOfUserCount.location, endOfUserCount)];
	...
	//	[socket addRoom:[testArg substringWithRange:NSMakeRange(0, endOfRoom.location)] withUserCount:[testArg substringWithRange:NSMakeRange(endOfRoom.location+1, endOfUserCount.location-endOfRoom.location)]];
		//	http://d.pr/AzCq
				NSLog(@"Stuffs... %@ %@ %@ %@ %@", testArg, NSStringFromRange(endOfRoom), [testArg substringWithRange:endOfRoom], NSStringFromRange(endOfUserCount), [testArg substringWithRange:endOfUserCount]);
	}
